    ...
    <section className="p-4 md:p-8 ">
      ...
      <div className="w-full md:w-11/12 lg:w-3/4 mx-auto p-6 md:p-10 bg-white rounded-2xl shadow-md mt-8 md:mt-16 flex flex-col md:flex-row">
        <div className="w-full md:w-2/3 md:pr-8 lg:pr-[16.66%] mb-8 md:mb-0 text-center md:text-left">
          <h4 className="text-xl md:text-2xl font-normal mb-5 md:mb-7">
            Leave a Message
          </h4>
          <ContactUsForm />
        </div>
        <div className="w-full md:w-1/3 text-sm md:text-xs text-center md:text-left">
          ...
          <div className="mb-2">portsaid-portfouad</div>
          <div className="mb-4">+201555389865</div>
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-8 h-8 rounded-full flex items-center justify-center ${social.className} duration-500 transition-all ease-in-out hover:scale-125`}
                >
